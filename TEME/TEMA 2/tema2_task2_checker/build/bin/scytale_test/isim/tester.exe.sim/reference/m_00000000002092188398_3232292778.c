...
#endif
static const char *ng0 = "D:/OneDrive - Universitatea Politehnica Bucuresti/ANUL III/SEMSTRUL I/AC/TEME/TEMA 2/tema2_task2_checker/build/bin/reference/ref_scytale_decryption.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
