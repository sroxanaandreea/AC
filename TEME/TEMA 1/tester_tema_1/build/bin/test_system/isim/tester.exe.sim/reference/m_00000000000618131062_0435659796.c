...
#endif
static const char *ng0 = "D:/OneDrive - Universitatea Politehnica Bucuresti/ANUL III/SEMSTRUL I/AC/TEME/TEMA 1/tester_tema_1/build/bin/reference/output_display.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
